...
adata_tcr = ir.io.read_10x_vdj("filtered_contig_annotations_tumor020420.csv")

# Load the associated blood transcriptomics data
adata = sc.read_10x_h5("filtered_feature_bc_matrix_tumor020420.h5")
...
tumor_subset_list = subset['barcode.'].tolist()
print('this is col_one_list')
print(tumor_subset_list)
...
tumor_sub_adata = adata[adata.obs_names.isin(tumor_subset_list)]
#tumor_sub_adata.to_csv("output_data/2020-01-26_tumor_sub_adata.csv")
